...
module.exports = {
    ...
    async post(req,res){
        ...
        /*const recipeFileResults = req.files.map(file=> RecipeFile.create({...file}))*/
        for(file of req.files){
            RecipeFile.create({...req.body, file_id: file.id, recipe_id: recipeId})
        }
        
        await Promise.all(fileResults,recipeFileResults )
